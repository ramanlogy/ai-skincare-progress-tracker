...
class SkinScan(db.Model):
    ...
    skin_type       = db.Column(db.String(50), default='Normal')
...
<div class="pc">
  <div class="ph">
    <div>
      ...
      {% if latest and latest.skin_type %}
      <p class="ps" style="color: var(--primary); font-weight: 500;">Currently tracking: {{ latest.skin_type }} Skin</p>
      {% endif %}
    </div>
...
<div class="pc pc--n">
  ...
  <div class="card">
    <form method="POST" action="/upload" enctype="multipart/form-data" id="uploadForm">
      ...
      <div class="field">
        <label for="skin_type">Skin Condition</label>
        <select name="skin_type" id="skin_type" style="width: 100%; padding: .75rem 1rem; border: 1px solid var(--border); border-radius: var(--radius-sm); font-family: 'Inter', sans-serif; font-size: .95rem; background: var(--bg-main); color: var(--text-main);">
  ...
  <div class="history-grid">
    ...
    <div class="hcard">
      ...
      <div class="hbody">
        ...
        {% if scan.skin_type and scan.skin_type != 'Normal' %}<p class="hnotes"><i data-lucide="droplet"></i> {{ scan.skin_type }} Skin</p>{% endif %}
